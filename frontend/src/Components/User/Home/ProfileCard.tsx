...
const ProfileCard: React.FC<IProfilCardProps> = ({ isFollowed }) => {
            ...
            <div id="profileCard" className='bg-white rounded-xl shadow-lg'>
                ...
                <div className="flex justify-center text-center">
                    <div className='mt-14 mb-10'>
                        ...
                        {isFollowed && <button className='outline-2 rounded-full px-2 bg-slate-300 hover:bg-blue-300 ms-2 mt-2'>Follow</button>}
                    </div>
                </div>
