                    ...
                    <div>
                        ...
                        <ul className="mt-6 space-y-2 tracking-wide">
                            <li className="min-w-max">
                                <Link to='/recruiter' aria-label="dashboard" className="relative flex items-center space-x-4 bg-gradient-to-r from-sky-600 to-cyan-400 px-4 py-3 text-white">
                            ...
                            <li className="min-w-max">
                                <Link to='/recruiter/all-jobs' className="bg group flex items-center space-x-4 rounded-full px-4 py-3 text-gray-600">
                                    ...
                                    <span className="group-hover:text-gray-700">All Jobs</span>
                                </Link>
                            </li>
                            <li className="min-w-max">
                                <Link to='/recruiter/applications' className="group flex items-center space-x-4 rounded-md px-4 py-3 text-gray-600">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                    ...
                                    <span className="group-hover:text-gray-700">All Applications</span>
                                </Link>
                            </li>
                            <li className="min-w-max">
                            ...
                            <li className="min-w-max">
                                <Link to='/recruiter/subscription' className="group flex items-center space-x-4 rounded-md px-4 py-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                    ...
                                    <span className="group-hover:text-gray-700">Subscription Plans</span>
                                </Link>

                            </li>
                            <li className="min-w-max rounded-3xl bg-gray-400 text-white font-semibold">
                                <Link to='/recruiter/post-jobform' className="group flex items-center space-x-4 rounded-md px-4 py-3">
                                    <LuFileEdit />
