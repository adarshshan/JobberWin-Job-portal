...
const Sidebar: React.FC<ISidebarProps> = ({ }) => {
    const [active, setActive] = useState(COLORS.A);

    const itemSelector = (item: string) => {
        setActive(item);
    }
    return (
                ...
                <div className="flex h-screen flex-col justify-between pt-2 pb-6">
                    <div>
                        ...
                        <ul className="mt-6 space-y-2 tracking-wide">
                            <li onClick={() => itemSelector(COLORS.A)} className="min-w-max">
                                <Link to='/recruiter' aria-label="dashboard" className={`relative flex items-center space-x-4 bg-gradient-to-r ${active === COLORS.A && 'bg-cyan-400 text-yellow-500'}  px-4 py-3`}>
                            ...
                            <li onClick={() => itemSelector(COLORS.B)} className="min-w-max">
                                <Link to='/recruiter/all-jobs' className={`bg group flex items-center space-x-4 rounded-full px-4 py-3 ${active === COLORS.B && 'bg-cyan-400 text-yellow-500'}  hover:bg-gray-700 hover:text-white`}>
                            ...
                            <li onClick={() => itemSelector(COLORS.C)} className="min-w-max">
                                <Link to='/recruiter/applications' className={`bg group flex items-center space-x-4 rounded-full px-4 py-3 ${active === COLORS.C && ' bg-cyan-400 text-yellow-500'}  hover:bg-gray-700 hover:text-white`}>
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                            ...
                            <li onClick={() => itemSelector(COLORS.D)} className="min-w-max hover:bg-gray-700 hover:text-white">
                                <Link to='/recruiter/subscription' className={`bg group flex items-center space-x-4 rounded-full px-4 py-3 ${active === COLORS.D && 'bg-cyan-400 text-yellow-500'}  hover:bg-gray-700 hover:text-white`}>
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                    ...
                                    <span className="">Subscription Plans</span>
                                </Link>

                            </li>
                            <li onClick={() => itemSelector(COLORS.E)} className="min-w-max rounded-3xl  hover:bg-gray-700 hover:text-white font-semibold">
                                <Link to='/recruiter/post-jobform' className={`bg group flex items-center space-x-4 rounded-full px-4 py-3 ${active === COLORS.E && 'from-sky-600 to-cyan-400 text-yellow-800'}  hover:bg-gray-700 hover:text-white`}>
                                    <LuFileEdit />
